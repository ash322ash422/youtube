...
from pydantic import BaseModel, Field #Type of data to specify
...
#def query_item_by_id(item_id: int, query_name: int = 2) -> Item: # makes query parameter optional with default val=2 
